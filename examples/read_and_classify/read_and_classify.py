...
incantation)::
    ...
    docker run --rm --gpus all --network host \\
        ...
        -w /workspace tensorrt-dev bash -c '
            ...
            python3 \\
            examples/read_and_classify/read_and_classify.py rtsp://localhost:8554/cam1 rtsp://localhost:8554/cam2
        '
...
# examples/classify_detections/classify_detections.py (kept in sync by hand, same convention as
