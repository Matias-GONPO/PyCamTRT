...
examples/classify_detections/classify_detections.py's own PARITY_GATE note below for what IS
...
examples/read_plates/read_plates.py's docstring for the full canonical incantation):
    ...
    docker run --rm --gpus all --network host \\
        ...
        -w /workspace tensorrt-dev bash -c '
            ...
            python3 \\
            examples/classify_detections/classify_detections.py rtsp://localhost:8554/cam1 rtsp://localhost:8554/cam2
        '
